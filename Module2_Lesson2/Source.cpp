...
void main()
{
...

	{
		...
		else if (v == 2)
		{
			...
			d = pow(b, 2) - (4 * a*c);
			printf("Дисриминант равен = %d\n", d);

			if (d < 0)
			{
				printf("Дискриминант не имеет корней. \n");
		...
		else if (v == 3)
		{
			...
			printf("Ввести значение a = \t");
			scanf("%d", &a);

			printf("Ввести значение b = \t");
			scanf("%d", &b);
		...
		{
			//4.	Вычислить рентабельность работы предприятия за месяц по формуле рент = прибыль/себестоимость100%, если себестоимость продукции в текущем месяце
			//   уменьшилась по сравнению с прошлым на 5 %. Значение прибыли и себестоимости за прошлый месяц ввести с экрана
